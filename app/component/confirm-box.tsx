...
export const ConfirmBox = ({ isOpen, title, message, onConfirm, onCancel }) => {
    if(!isOpen) return null;
    return <div className={`fixed inset-0 z-40 min-h-full overflow-y-auto overflow-x-hidden transition flex items-center`}>
